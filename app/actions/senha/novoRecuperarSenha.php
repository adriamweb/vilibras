...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        header("Location: ../../pages/senha/novoRecuperarSenhaForm.php?status=error&message=E-mail inválido.");
        exit;
    }
    ...
    if ($stmt->num_rows == 0) {
        header("Location: ../../pages/senha/novoRecuperarSenhaForm.php?status=error&message=E-mail não encontrado.");
        desconecta();
        exit;
    }
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'adrianasam853@gmail.com'; // Seu endereço de e-mail
        ...
        $mail->setFrom('adrianasam853@gmail.com', 'VILIBRAS');
        ...
        $mail->send();
        header("Location: ../../pages/senha/novoRecuperarSenhaForm.php?status=success&message=E-mail de redefinição de senha enviado.");
    } catch (Exception $e) {
        header("Location: ../../pages/senha/novoRecuperarSenhaForm.php?status=error&message=Erro ao enviar o e-mail");
    }
}